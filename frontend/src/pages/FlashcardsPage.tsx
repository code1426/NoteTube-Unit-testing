...
const FlashcardsPage: React.FC = () => {
  ...
  return (
    <>
      <Toaster />
      <div className="bg-white dark:bg-dark-background relative w-full flex flex-col items-center pb-14 scrollbar-custom">
        <Header
          isHomepage={false}
        ...
        <div className="w-[90%]">
          <div
            className="pb-10 w-full text-green-700 dark:text-green text-2xl md:text-4xl lg:text-4xl xl:text-3xl flex gap-3 font-primaryBold align-middle items-center"
            style={{
