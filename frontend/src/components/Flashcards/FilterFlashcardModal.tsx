  ...
  return (
    <Card className="flex-grow absolute top-12 right-0 z-50 bg-white dark:bg-dark-background p-2 rounded-lg shadow-lg w-[20rem] border dark:border-dark-border border-gray-300">
      ...
      <CardContent className="grid grid-cols-3 gap-2 items-center">
        <h2 className="col-span-1 text-lg font-medium dark:text-white text-gray-700">
          Sort By
        </h2>
      ...
      <CardFooter className="justify-end">
        <button
          className="justify-end bg-green text-sm font-medium text-white px-4 py-2 rounded-lg hover:bg-green-600"
          onClick={handleApply}
        >
          Apply
        </button>
