...
const ProfileButton = ({ isDropdown = false }: Props) => {
  ...
  return (
    <div
      className={`outline-none cursor-pointer  gap-2 px-1 rounded-full transition-all flex flex-col justify-center items-center ${isDropdown && "min-w-44 w-60 active:bg-white"}`}
    >
