...
const JoinUsSection = () => {
  return (
    <div className="bg-white bg-opacity-85 py-16 px-8 flex justify-center items-center">
      <div className="bg-green/10 rounded-3xl flex items-center max-w-6xl w-full overflow-hidden shadow-lg">
