...
const MainHeader = () => {
  ...
  return (
    <>
      <TooltipProvider>
        <div className="fixed top-0 select-none h-16 w-full bg-white dark:bg-dark-background dark:border-dark-border z-20 border-b px-4 border-gray-300 shadow-sm dark:shadow-dark-border shadow-gray-200 flex flex-row justify-between items-center">
