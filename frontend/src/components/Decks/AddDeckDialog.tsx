    ...
    <DialogContent className="sm:max-w-[425px] bg-white p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleCreateDeck}>
        <div className="relative">
          <Input
            className="px-2.5 py-1.5 pr-11 rounded-lg border bg-whit focus:outline-none focus:ring-1 focus:ring-green focus:ring-offset-2 hover:outline-none hover:ring-green hover:ring-1 hover:ring-offset-2 transition-all"
